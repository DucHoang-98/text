...
public class GiangVien extends CanBo{
	...
	public double tienPhuCap() {
		if("Tiến sĩ".equals(trinhDo)||"Ts".equals(trinhDo)||"ts".equals(trinhDo)||"tiensi".equals(trinhDo)||"TS".equals(trinhDo)) {
			phuCap = 1000;
		}else if("Thạc sĩ".equals(trinhDo)||"Ths".equals(trinhDo)||"ThS".equals(trinhDo)||"THS".equals(trinhDo)||"ths".equals(trinhDo)||"thacsi".equals(trinhDo)){
			phuCap = 500;
		}else {
			phuCap =300;
		}
